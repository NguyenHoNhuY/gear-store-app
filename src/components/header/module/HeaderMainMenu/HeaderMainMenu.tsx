    ...
    return (
        <div className="w-full bg-main-color py-1">
            <div className="container mx-auto hidden items-center lg:flex">
                <div className="flex h-full w-[14%] select-none items-center whitespace-nowrap rounded-md border-none bg-main-color-100 py-2 text-[12px] font-medium text-white">
